...
JsonObject& WifiConnection::prepareResponse(JsonBuffer& jsonBuffer) {
  ...
  root["NAME"] = "WallClock";
  root["STATUS"] = STATE_BRIGHTNESS;
//  root["RED_RGB"] = RED_RGB;
//  root["GREEN_RGB"] = GREEN_RGB;
//  root["BLUE_RGB"] = BLUE_RGB;
//  root["BRIGHTNESS_STATUS"] = STATE_BRIGHTNESS;
//  root["BRIGHTNESS_VALUE"] = STATE_BRIGHTNESS;
...
//        colorProperties.red = PickParameter("RED_RGB=", HTML_String);
